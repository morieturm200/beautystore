...
<div class="catalog-container">
                ...
                <select name="brand" class="brand-select" onchange="this.form.submit()">
                    ...
                    while($b = $brands->fetch_assoc()): ?>
                        <option value="<?php echo htmlspecialchars($b['manufacturer']); ?>" <?php echo $brand_filter == $b['manufacturer'] ? 'selected' : ''; ?>>
                            <?php echo htmlspecialchars($b['manufacturer']); ?>
                        </option>
                    <?php endwhile; ?>
                </select>
            </div>
    ...
    <main class="main-content">
        <div class="top-bar">
            <h1><?php echo !empty($search_query) ? 'Результати для: '.htmlspecialchars($search_query) : htmlspecialchars($sub_filter ?: ($cat_filter ?: 'Каталог')); ?></h1>
            
            <select class="brand-select" style="width:auto;" onchange="document.getElementById('hiddenSort').value = this.value; document.getElementById('filterForm').submit();">
                ...
                <div class="card">
                    ...
                    <div class="img-box">
                        ...
                        <a href="product_details.php?id=<?php echo $p_id; ?>">
                            <img src="<?php echo !empty($row['image_url']) ? htmlspecialchars($row['image_url']) : 'img/products/'.$p_id.'.jpg'; ?>" onerror="this.src='https://placehold.co/400x500?text=BeautyStore'">
                        </a>
                    </div>
