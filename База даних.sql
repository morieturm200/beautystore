...
CREATE TABLE `Order_Details` (
  ...
  KEY `fk_order_details_user` (`user_id`),
  ...
  CONSTRAINT `fk_order_details_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
...
-- Dump completed on 2026-04-27  9:27:58
