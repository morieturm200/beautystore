...
// 1. ПІДКЛЮЧЕННЯ (Використовуємо вже існуюче в проекті mysqli)
...
// 2. ОБРОБКА ВИДАЛЕННЯ (Перероблено на mysqli)
...
if (!empty($wishlist_ids)) {
    ...
    // Додаємо LEFT JOIN Images, щоб картинки були реальні, а не заглушки
    $sql = "SELECT p.*, 
...
<head>
    ...
    <style>
        /* Твої стилі залишаються без змін, вони чудові */
