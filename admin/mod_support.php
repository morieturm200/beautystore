...
// 2. ОБРОБКА ВІДПОВІДІ (Збереження відповіді адміна)
...
// 3. ОТРИМАННЯ СПИСКУ ДІАЛОГІВ (Групування повідомлень по клієнтах)
...
// 4. ЗАВАНТАЖЕННЯ КОНКРЕТНОГО ЧАТУ
...
<script>
    // Скрол до останнього повідомлення при відкритті чату
