...
// Якщо сесія порожня — відправляємо на вхід
if (!isset($_SESSION['customer_id'])) {
    header("Location: login_register.php");
    exit();
}

// 2. ПІДКЛЮЧЕННЯ (виправлено на beautyuser)
...
if ($result && $result->num_rows > 0) {
    ...
    // Якщо юзера не знайдено в базі (наприклад, видалили акаунт)
    session_destroy();
    header("Location: login_register.php");
    exit();
}
...
<div class="profile-card">
    ...
    <div class="info-grid">
        ...
        <div class="info-item">
            ...
            <div class="value">
                <?php 
                // Перевірка на VIP статус (якщо є колонка discount або аналогічна)
